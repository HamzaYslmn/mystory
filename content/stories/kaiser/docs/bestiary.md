...
- Danger: slow, but dissolves whatever it engulfs — flesh, wood, armor
...
- Danger: high to a lone traveler — it snatches prey off open ground; a **feather** fetches ~10 gold
...
- Danger: a flying venomous hunter; a **venom** vial runs ~8 gold
...
Cats, dogs, hunting hounds, falcons, horses, mules, oxen — ordinary animals, no crystal and no magic,
priced in [Economics](economics.md). Two deserve a note: the **riding lizard** (a horse-analog mount in
warmer lands, ~60 gold) and the **messenger-hawk** (drilled to carry notes with scribed lures — the
*training* is the craft, not the bird; ~50 gold). Neither casts.
